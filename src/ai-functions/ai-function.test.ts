...
describe('AiFunction', () => {
    test('renders basic template with params', () => {
        ...
        class TestAiFunction extends AiFunction<CalculatorResponse> {
            constructor(aiExecutionEngine?: AiExecutionEngineBase) {
                super({
                    ...
                    prompt: new Prompt('You are a true calculator, calculate and return the result of the following expression: {evaluation}'),
        ...
        expect(renderedPrompt).toEqual(`You are a true calculator, calculate and return the result of the following expression: 2 + 2
